...
function Navigation(_ref) {
  ...
  return __jsx("nav", {
    ...
    id: "menuHome",
    href: "/",
    className: "text-white px-3 py-2 rounded-md text-sm font-medium {isHomeActive}",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 76,
